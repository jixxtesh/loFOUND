...
import { faPhone, faEnvelopeOpenText, faSearch } from "@fortawesome/free-solid-svg-icons";
    ...
    <section id="how-it-works" className="py-8">
        <div className="container mx-auto text-center text-navy">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 ">
            ...
            <div className="feature">
            <FontAwesomeIcon icon={faPhone} className="mb-6 text-6xl"/>
              <h3 className="text-xl font-semibold mb-2">
                Connect with Owners
              </h3>
              <p className='text-gray-600'>
                phone the owners of found items to arrange a pickup or return.
              </p>
            </div>
          </div>
        </div>
