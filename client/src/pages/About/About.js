    ...
    <div className="max-w-5xl mx-auto bg-white min-h-[calc(100vh-58px)] shadow-md px-12">
      ...
      <section className="mb-6">
        ...
        <p className="text-gray-600 ">
          ...
          loFOUND streamlines the process of reporting lost belongings and helps ensure their return to the rightful owners. By leveraging technology, we aim to improve the overall 
